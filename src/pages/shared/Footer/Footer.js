...
const Footer = () => {
    return (
        <footer className="bg-base-200 text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flexWrap md:text-left text-center -mb-10 -mx-4">
      <div className="lg:w-1/6 md:w-1/2 w-full px-4">
        <h2 className="title-font font-medium text-gray-900 trackingWidest text-sm mb-3">CATEGORIES</h2>
  ...
  <div className="border-t border-gray-200">
    <div className="container px-5 py-8 flex flexWrap mx-auto items-center">
      <div className="flex md:flex-nowrap flexWrap justify-center items-end md:justify-start">
        ...
        <button className="inline-flex textWhite bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Button</button>
  ...
  <div className="bg-gray-100">
    <div className="container mx-auto py-4 px-5 flex flexWrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© 2020 Tailblocks —
        <Link href="https://twitter.com/knyttneve" className="text-gray-600 ml-1" target="_blank" rel="noopener noreferrer">@knyttneve</Link>
      </p>
