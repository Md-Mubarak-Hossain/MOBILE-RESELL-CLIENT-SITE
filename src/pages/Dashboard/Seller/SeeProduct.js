                    ...
                    mobile.map(d => <div key={d._id} className="hero border">
                        <div className="hero-content flex-col lg:flex-row p-2">
                            ...
                            <div>
                                ...
                                <Link to={`/deleteSellerProduct/${d._id}`}><button className="btn btn-primary btn-sm">X</button></Link>
                                <Link to={`/updateSellerProduct/${d._id}`}> <button className="btn btn-primary btn-sm">update</button></Link>
                            </div>
                        </div>
                    </div>)
                }
