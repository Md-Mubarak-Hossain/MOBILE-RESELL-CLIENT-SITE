            ...
            <div className='grid grid-cols-1 md:gap-2 md:grid-cols-4'>
                {
                    mobile?.map(d => <div key={d._id} className="hero">
                        <div className="w-full flex flex-col place-items-center">
                            <div>
                                <img alt='img' src={d.picture} className=" rounded-lg shadow-xl md:w-24 md:h-32" />
                            </div>
                            <div>
                                <h1 className="text-xl md:text-xs font-bold">{d.name}</h1>
                                <p className="text-xl md:text-xs">Brand:{d.brand}</p>
                                <p className="text-xl md:text-xs">Category:{d.category}</p>
                                <p className="text-xl md:text-xs">Seller:{d.seller}</p>
                                <p className="text-xl md:text-xs">Ram:{d.ram}</p>
                                <p className="text-xl md:text-xs">Camera:{d.camera}</p>
                                <p className="text-xl md:text-xs">Battery:{d.battery}</p>
                                <p className="text-xl md:text-xs">useTime:{d.useTime}</p>
                                <p className="text-xl md:text-xs">price:{d.price}</p>
                                <p className="text-xl md:text-xs">resalePrice:{d.resalePrice}</p>
                                <p className="text-xl md:text-xs">location:{d.location}</p>
